...
class TestLambda(TestCase):
    def setUp(self):
        ...
        with open('test_images/religious_aijesus_440x248.jpeg', 'rb') as file:
            self.test_image_religious = base64.b64encode(file.read()).decode('utf-8')
        with open('test_images/gun_toting_man_624x352.jpeg', 'rb') as file:
            self.test_image_gun = base64.b64encode(file.read()).decode('utf-8')
        with open('test_images/renaissance_painting_nude_900x632.jpg', 'rb') as file:
