...
class TestLambda(TestCase):
    def setUp(self):
        ...
        with open('lambdas/classifier/tests/game_stream_440x248.jpeg', 'rb') as file:
            self.test_image_game_stream = base64.b64encode(file.read()).decode('utf-8')
        with open('lambdas/classifier/tests/underwear_not_nude_440x248.jpeg', 'rb') as file:
            self.test_image_underwear = base64.b64encode(file.read()).decode('utf-8')
        with open('lambdas/classifier/tests/religious_aijesus_440x248.jpeg', 'rb') as file:
            self.test_image_religious = base64.b64encode(file.read()).decode('utf-8')
        with open('lambdas/classifier/tests/gun_toting_man_624x352.jpeg', 'rb') as file:
            self.test_image_gun = base64.b64encode(file.read()).decode('utf-8')
        with open('lambdas/classifier/tests/renaissance_painting_nude_900x632.jpg', 'rb') as file:
